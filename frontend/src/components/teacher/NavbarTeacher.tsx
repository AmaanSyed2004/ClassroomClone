      ...
      <Sheet>
        ...
        <SheetContent side="left">
          ...
          <div className="w-[200px]  p-4 flex flex-col h-1/2 justify-between">
            <Link to="/HomePage" className="text-3xl font-medium hover:underline underline-offset-4" >
              Home
            </Link>
            <Link to="/HomePage/create" className="text-3xl font-medium hover:underline underline-offset-4" >
              Create a class
            </Link>
